...
class GroupService {
    ...
    static async InsertGroup(groupName, userId, group_description, invite_code) {
        ...
        try {
            ...
            console.error("Error di Service Group (InsertGroup):", err.message);
            throw err;
        }
    }
    ...
    static async JoinGroup(group_id, user_id, user_role) {
        ...
        try {
            ...
            console.error("Error di Service Group (JoinGroup):", err.message);
            throw err;
        }
    }
    ...
    static async KickGroup(group_id, user_id, requester_user_id) {
        ...
        try {
            ...
            console.error("Error di Service Group (KickGroup):", err.message);
            throw err;
        }
    }
    ...
    static async GetGroup(group_id) {
        try {
            ...
            console.error("Error di Service Group (GetGroup):", err.message);
            throw err;
        }
    }
    ...
    static async GetInviteCode(group_id) {
        try {
            ...
            console.error("Error di Service Group (GetInviteCode):", err.message);
            throw err;
        }
    }
    ...
    static async GetGroupbyInviteCode(invite_code) {
        try {
            ...
            console.error("Error di Service Group (GetGroupbyInviteCode):", err.message);
            throw err;
        }
    }
    ...
    static async GetGroupByUserID(user_id) {
        try {
            ...
            console.error("Error di Service Group (GetGroupByUserID):", err.message);
            throw err;
        }
    }
    ...
    static async UpdateGroup(group_id, user_id, group_name, group_description) {
        ...
        try {
            ...
            console.error("Error di Service Group (UpdateGroup):", err.message);
            throw err;
        }
    }
    ...
    static async UpdateUserRole(group_id, user_id, requester_id, user_role) {
        ...
        try {
            ...
            console.error("Error di Service Group (UpdateUserRole):", err.message);
            throw err;
        }
    }
}
